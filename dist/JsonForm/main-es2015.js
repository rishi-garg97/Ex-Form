...
/* harmony import */ var angularx_social_login__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! angularx-social-login */ "./node_modules/angularx-social-login/angularx-social-login.js");
...
/* harmony import */ var ang_jsoneditor__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/fesm2015/ang-jsoneditor.js");
...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/es2015/index.js");
...
let FormBuildingService = class FormBuildingService {
    constructor() { }
};
...
let DropdownComponent = class DropdownComponent {
    constructor(formBuilder) {
        ...
        this.getError = () => {
            return _validators_validation_message_generator__WEBPACK_IMPORTED_MODULE_3__["ValidationMessageGenerator"].errorMessage(this.formGroup, this.property);
        };
    }
    ngOnInit() {
        this.addValidator();
...
let EmailFieldComponent = class EmailFieldComponent {
    constructor(formBuilder) {
        ...
        this.getError = () => {
            return _validators_validation_message_generator__WEBPACK_IMPORTED_MODULE_4__["ValidationMessageGenerator"].errorMessage(this.formGroup, this.property);
        };
    }
    ngOnInit() {
        this.addValidator();
...
let NumberFieldComponent = class NumberFieldComponent {
    constructor(formService, formBuilder) {
        ...
        this.addValidator = () => {
            ...
            if (this.property.max && this.property.max != null) {
                validators.push(new _validators_max_value_validator__WEBPACK_IMPORTED_MODULE_6__["MaxValueValidator"]().get(this.property.max));
            }
            if (this.property.max && this.property.min != null) {
                validators.push(new _validators_min_value_validator__WEBPACK_IMPORTED_MODULE_7__["MinValueValidator"]().get(this.property.min));
            }
            if (this.property.pattern && this.property.pattern != null) {
                validators.push(new _validators_pattern_validator__WEBPACK_IMPORTED_MODULE_8__["PatternValidator"]().get(this.property.pattern));
            }
            this.formGroup = this.formBuilder.group({ [this.property.name]: [{ value: "", disabled: !this.property.enable }, validators] });
            this.formGroup.updateValueAndValidity();
            this.addControl.emit({ key: this.property.name, value: this.formGroup });
    ...
    constructor(formBuilder) {
        ...
        this.addValidator = () => {
            ...
            if (this.property.minLength && this.property.minLength != null) {
                validators.push(new _validators_min_length_validators__WEBPACK_IMPORTED_MODULE_5__["MinLengthValidator"]().get(this.property.minLength));
            }
            if (this.property.maxLength && this.property.maxLength != null) {
                validators.push(new _validators_max_length_validator__WEBPACK_IMPORTED_MODULE_3__["MaxLengthValidator"]().get(this.property.maxLength));
            }
            if (this.property.pattern && this.property.pattern != null) {
                validators.push(new _validators_pattern_validator__WEBPACK_IMPORTED_MODULE_4__["PatternValidator"]().get(this.property.pattern));
            }
            this.formGroup = this.formBuilder.group({ [this.property.name]: [{ value: "", disabled: !this.property.enable }, validators] });
            this.formGroup.updateValueAndValidity();
            this.addControl.emit({ key: this.property.name, value: this.formGroup });
        ...
        this.getError = () => {
            return _validators_validation_message_generator__WEBPACK_IMPORTED_MODULE_6__["ValidationMessageGenerator"].errorMessage(this.formGroup, this.property);
        };
    }
    ngOnInit() {
        this.addValidator();
...
let TextFieldComponent = class TextFieldComponent {
    constructor(formBuilder) {
        ...
        this.addValidator = () => {
            ...
            if (this.property.minLength && this.property.minLength != null) {
                validators.push(new _validators_min_length_validators__WEBPACK_IMPORTED_MODULE_4__["MinLengthValidator"]().get(this.property.minLength));
            }
            if (this.property.maxLength && this.property.maxLength != null) {
                validators.push(new _validators_max_length_validator__WEBPACK_IMPORTED_MODULE_5__["MaxLengthValidator"]().get(this.property.maxLength));
            }
            if (this.property.pattern && this.property.pattern != null) {
                validators.push(new _validators_pattern_validator__WEBPACK_IMPORTED_MODULE_6__["PatternValidator"]().get(this.property.pattern));
            }
            this.formGroup = this.formBuilder.group({ [this.property.name]: [{ value: "", disabled: !this.property.enable }, validators] });
            this.formGroup.updateValueAndValidity();
            this.addControl.emit({ key: this.property.name, value: this.formGroup });
        ...
        this.getError = () => {
            return _validators_validation_message_generator__WEBPACK_IMPORTED_MODULE_2__["ValidationMessageGenerator"].errorMessage(this.formGroup, this.property);
        };
    }
    ngOnInit() {
        this.addValidator();
    ...
    constructor() {
        this.initialize = () => {
            ...
            if (uiSchema.type === "Normal") {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_2___default.a.each(uiSchema.steps, (step) => {
        ...
        this.formatFields = (schema) => {
            return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.map(schema.fields, (field) => {
                const matchedField = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.find(this.modelSchema.properties, { name: field.name });
                if (matchedField) {
...
ValidationMessageGenerator.errorMessage = (formGroup, property) => {
    let msg = "Field is Invalid";
    const control = formGroup.get(property.name);
    const fieldError = _validation_message_json__WEBPACK_IMPORTED_MODULE_0__.fields[property.name] ? _validation_message_json__WEBPACK_IMPORTED_MODULE_0__.fields[property.name] : "";
...
let AccordianComponent = class AccordianComponent {
    constructor(formBuilder) {
        ...
        this.step = 0;
        this.addControl = (data) => {
            lodash__WEBPACK_IMPORTED_MODULE_3___default.a.each(this.uiSchema.steps, (step) => {
                const matchedField = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.find(step.fields, (field) => {
    ...
    ngOnInit() {
        ...
        const allSteps = [];
        const steps = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.range(this.uiSchema.totalSteps);
        steps.forEach((step) => {
...
let DashboardService = class DashboardService {
    constructor(http) {
        ...
        this.enitityModelSchema = (name) => {
            ...
            const entitySchema = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.find(schema, (formSchema) => {
                if (formSchema.name === name) {
                    return formSchema;
                }
            });
            ...
            this.schema.model.editor = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.clone(modelEditor);
        ...
        this.uiSchema = (type) => {
            const uiEditor = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.find(_assets_ui_schema_json__WEBPACK_IMPORTED_MODULE_2__, { type });
            this.schema.ui.form = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.cloneDeep(uiEditor);
            this.schema.ui.editor = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.cloneDeep(uiEditor);
...
let LoginComponent = class LoginComponent {
    constructor(router, dialogRef, data, formBuilder, authService, commonService, snackBarMessageService, dialog) {
        ...
        this.dialog = dialog;
        this.login = (mode) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        this.openSignupDialog = () => {
            ...
            const dialogRef = this.dialog.open(_signup_signup_component__WEBPACK_IMPORTED_MODULE_8__["SignupComponent"]);
...
let AuthService = class AuthService {
    ...
    router) {
        ...
        this.SignUp = (email, password) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
        ...
        // Sign in with Google
        this.GoogleAuth = () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const result = yield this.afAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider());
                this.SetUserData(result.user);
            }
            catch (error) {
                window.alert(error);
...
let SignupComponent = class SignupComponent {
    constructor(router, dialogRef, data, formBuilder, formBuildingService, authService, commonService, snackBarMessageService) {
        this.router = router;
        this.dialogRef = dialogRef;
        this.data = data;
        this.formBuilder = formBuilder;
        ...
        this.signup = () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.commonService.showHideSpinner(true);
            try {
        ...
        this.getError = (fieldName) => {
            ...
            if (this.formGroup.controls[fieldName].hasError("pattern") && fieldName === ("password" || false)) {
...
let AuthenticationGuard = class AuthenticationGuard {
    ...
    canActivate(next, state) {
        if (!this.authService.isLoggedIn) {
            const dialogRef = this.dialog.open(_entryComponent_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"]);
            dialogRef.afterClosed().subscribe(result => {
            });
            return false;
        }
...
let ToolBarComponent = class ToolBarComponent {
    constructor(dialog, authService) {
        ...
        this.openLoginDialog = () => {
            const dialogRef = this.dialog.open(_entryComponent_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"]);
            dialogRef.afterClosed().subscribe(result => {
            });
        };
        this.openSignupDialog = () => {
            const dialogRef = this.dialog.open(_entryComponent_signup_signup_component__WEBPACK_IMPORTED_MODULE_4__["SignupComponent"]);
            dialogRef.afterClosed().subscribe(result => {
            });
        };
    }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ang_jsoneditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/fesm2015/ang-jsoneditor.js");
